...
static const int LAST_POW_BLOCK = 500000; // at 30 second blocks will be about 30 days from launch
...
static const int64_t MAX_MONEY = 221 * COIN;
...
static const uint256 hashGenesisBlock("0000084eec5c77eae290fb9d5dde57f3555dacdc1f06b3ac31ec4c93b6ace1ff");
static const uint256 hashGenesisBlockTestNet("0000084eec5c77eae290fb9d5dde57f3555dacdc1f06b3ac31ec4c93b6ace1ff");

static const uint256 CheckBlock1 ("000000badc86548030eaf8f14b6d87dc12da365b5c7c1f56002ec4a1765c1c46"); // Checkpoint at block 1
...
public:
    ...
    {
        // sherlockcoinv2: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // sherlockcoinv2: get transaction coin age
...
public:
    ...
    // sherlockcoinv2: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // sherlockcoinv2: two types of block: proof-of-work or proof-of-stake
    ...
    // sherlockcoinv2: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // sherlockcoinv2: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // sherlockcoinv2: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // sherlockcoinv2: block index flags
    enum  
    {
