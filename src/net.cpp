...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("sherlockcoinv2-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("sherlockcoinv2-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("sherlockcoinv2-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "SherlockCoinV2 " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"sherlockcoinv2.no-ip.biz", "sherlockcoinv2.no-ip.biz"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("sherlockcoinv2-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("sherlockcoinv2-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("sherlockcoinv2-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("sherlockcoinv2-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. SherlockCoinV2 is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("sherlockcoinv2-start");
